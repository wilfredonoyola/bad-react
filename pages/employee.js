    ...
    <Layout isAuth={props.isAuth}>
      <div className="nav-scroller bg-white shadow-sm">
        <nav className="nav nav-underline">
          ...
          <a href="/people" className="p-2 text-dark nav-link">
            Personas
          </a>
          <a className="p-2 nav-link active disabled" href="#">Empleados</a>
        </nav>
      </div>
      <div className="d-flex align-items-center p-3 mb-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div className="lh-100">
          <h6 className="mb-0 text-white lh-100">Administrar Empleados</h6>
        </div>
      </div>
      <div className="my-3 p-3 bg-white rounded shadow-sm">
        <h6 className="pb-2 mb-0 float-left">Todos Empleados</h6>
        <a href='/add_employee' className="p-2 mb-2 btn btn-primary float-right">
...
People.getInitialProps = async ctx => {
  ...
  const url = `${process.env.API_URL}/Empleadoes`
  try {
